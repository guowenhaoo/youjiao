...
import { getActivitiesAddress,getActivitiesObject,getActivitiesBus,editActivities } from "../../../api/activitiesApi";
...
export default class ActivitiesAdd extends Component {
    ...
    componentDidMount(){
        ...
        if(item){
            ...
            // actitem.activities_time = Moment(actitem.activities_time),
            ...
            this.setState({
                activities_id:actitem.id,
                imageUrl:actitem.activities_img,
                focusImgUrl:actitem.focus_img,
                activities_intro: actitem.activities_intro,
                activities_trip: actitem.activities_trip,
                activities_days:actitem.activities_days,
                activities_notice: actitem.activities_notice,
                activities_tag: actitem.activities_tag.split(',')
    ...
    render() {
            let {activities_tag,activities_intro,activities_trip,activities_days,activities_notice,focusImgUrl,imageUrl,activities_address,activities_object ,activities_bus_day} = this.state
            const onFinish= values=>{
                // console.log(values);
                let {activities_tag,imageUrl,activities_id, focusImgUrl} = this.state
               ...
               //发请求添加活动
               editActivities(getUser().token,activities_id, values.activities_name, activities_time, imageUrl, 
